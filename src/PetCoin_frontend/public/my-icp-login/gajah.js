...
const ekspresiBear = {
    normal: "./png/gajah 1.png",
    love: "./png/gajah seneng.png", // Added a 'love' image for the expression.
    sad: "./png/gajah sedih.png"
};

const itemData = {
    hair: [
        { name: "Long Elephant Hair", price: 300, image: "./png/long gajah.png" },
        { name: "Curly Elephant Hair", price: 300, image: "./png/curly gajah.png" },
        { name: "Short Elephant Hair", price: 300, image: "./png/short gajah.png" }
    ],
    accessories: [
        { name: "Elephant Scarf", price: 300, image: "./png/syal gajah.png" },
        { name: "Elephant Hat", price: 300, image: "./png/hat gajah.png" },
        { name: "Elephant Necklace", price: 300, image: "./png/kalung gajah.png" }
    ],
    playTools: [
...
function showExpression(type, duration = 0) {
    ...
    if (terpasang.hair) {
        ...
        if (itemRambut) {
            if (type === 'love') {
                // Corrected the image path for 'love' expression to 'seneng' (happy)
